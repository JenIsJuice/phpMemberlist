  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="disable"><a href="add.php" target="_self">新增</a></li>
          <li class="disable"><a href="manage.php" target="_self">管理</a></li>
    </ul>
  </div>
  </div>
</nav>
...
<!--div class="col-lg-12"縮減-->
            <div class="well bs-component">
              <form action="change.php?id=<?php echo $_GET["id"]?>" method="POST" style="margin:10px 0 0 0;" class="form-horizontal" >
                <fieldset class="info">
                  <legend class="navbar-brand">修改雷姆</legend>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <input type="text" name="name" class="form-control" id="inputName" placeholder="輸入姓名" value= <?php echo $display['name'];?>>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputTel" class="col-lg-2 control-label">電話</label>
                    <div class="col-lg-8">
                      <input type="text" name="phone" class="form-control" id="inputTel" placeholder="輸入電話" value= <?php echo $display['phone'];?>>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail" class="col-lg-2 control-label">信箱</label>
                    <div class="col-lg-8">
                      <input type="email" name="email" class="form-control" id="inputEmail" placeholder="輸入信箱" value= <?php echo $display['email'];?>>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputAddress" class="col-lg-2 control-label">地址</label>
                    <div class="col-lg-8">
                      <input type="text" name="address" class="form-control" id="inputAddress" placeholder="輸入地址" value= <?php echo $display['address'];?>>
                    </div>
                  </div>
                  <div class="form-group">
